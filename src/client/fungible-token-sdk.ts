...
export class FungibleTokenClient<PS extends FungibleTokenPrivateState = FungibleTokenPrivateState> {
  ...
  public async adminReallocate(
    ...
    const callerBytes = FungibleTokenClient.toBytes32(caller);
    const trappedBytes = FungibleTokenClient.toBytes32(trappedAccount);
    const targetBytes = FungibleTokenClient.toBytes32(targetSpendableAccount);
...
export { FungibleTokenClient as FungibleTokenV23Client };
export { FungibleTokenClient as FungibleTokenV23SDK };
